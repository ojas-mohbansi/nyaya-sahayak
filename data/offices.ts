...
const SEEDS: Seed[] = [
  ...
  {
    state: "Arunachal Pradesh",
    district: "Ziro (Lower Subansiri)",
    city: "Ziro",
    lat: 27.563,
    lng: 93.827,
  },
  { state: "Arunachal Pradesh", district: "Tezu (Lohit)", city: "Tezu", lat: 27.921, lng: 96.161 },
  ...
  // ───────────── Assam ─────────────
  {
    ...
    lat: 26.1445,
    lng: 91.7362,
    collectorPhone: "0361-2734502",
  },
  { state: "Assam", district: "Dibrugarh", city: "Dibrugarh", lat: 27.4728, lng: 94.912 },
  ...
  { state: "Assam", district: "Nagaon", city: "Nagaon", lat: 26.345, lng: 92.684 },
  { state: "Assam", district: "Tinsukia", city: "Tinsukia", lat: 27.4922, lng: 95.3468 },
  { state: "Assam", district: "Barpeta", city: "Barpeta", lat: 26.322, lng: 91.005 },
  ...
  { state: "Bihar", district: "Begusarai", city: "Begusarai", lat: 25.418, lng: 86.129 },
  {
    state: "Bihar",
    district: "Nalanda (Bihar Sharif)",
    city: "Bihar Sharif",
    lat: 25.198,
    lng: 85.523,
  },
  { state: "Bihar", district: "Saran (Chhapra)", city: "Chhapra", lat: 25.7805, lng: 84.7475 },
  { state: "Bihar", district: "Katihar", city: "Katihar", lat: 25.539, lng: 87.579 },
  { state: "Bihar", district: "Munger", city: "Munger", lat: 25.376, lng: 86.473 },
  ...
  // ───────────── Chhattisgarh ─────────────
  {
    ...
    lat: 21.2514,
    lng: 81.6296,
    collectorPhone: "0771-2445001",
  },
  { state: "Chhattisgarh", district: "Bilaspur", city: "Bilaspur", lat: 22.0797, lng: 82.1409 },
  { state: "Chhattisgarh", district: "Durg", city: "Durg", lat: 21.19, lng: 81.2849 },
  ...
  { state: "Chhattisgarh", district: "Raigarh", city: "Raigarh", lat: 21.8974, lng: 83.395 },
  {
    state: "Chhattisgarh",
    district: "Jagdalpur (Bastar)",
    city: "Jagdalpur",
    lat: 19.0805,
    lng: 82.0339,
  },
  ...
  { state: "Gujarat", district: "Mehsana", city: "Mehsana", lat: 23.598, lng: 72.379 },
  ...
  { state: "Haryana", district: "Yamunanagar", city: "Yamunanagar", lat: 30.129, lng: 77.2674 },
  ...
  // ───────────── Himachal Pradesh ─────────────
  {
    ...
    lat: 31.1048,
    lng: 77.1734,
    collectorPhone: "0177-2657005",
  },
  { state: "Himachal Pradesh", district: "Mandi", city: "Mandi", lat: 31.708, lng: 76.932 },
  {
    state: "Himachal Pradesh",
  ...
  { state: "Himachal Pradesh", district: "Hamirpur", city: "Hamirpur", lat: 31.684, lng: 76.521 },
  { state: "Himachal Pradesh", district: "Una", city: "Una", lat: 31.4685, lng: 76.2708 },
  { state: "Himachal Pradesh", district: "Chamba", city: "Chamba", lat: 32.553, lng: 76.126 },
  {
    state: "Himachal Pradesh",
  ...
  { state: "Jharkhand", district: "Dumka", city: "Dumka", lat: 24.268, lng: 87.249 },
  ...
  { state: "Karnataka", district: "Hubballi-Dharwad", city: "Hubballi", lat: 15.3647, lng: 75.124 },
  ...
  { state: "Karnataka", district: "Tumakuru", city: "Tumakuru", lat: 13.3392, lng: 77.114 },
  ...
  { state: "Karnataka", district: "Vijayapura", city: "Vijayapura", lat: 16.8302, lng: 75.71 },
  ...
  // ───────────── Kerala ─────────────
  {
    ...
    lat: 8.5241,
    lng: 76.9366,
    collectorPhone: "0471-2730045",
  },
  { state: "Kerala", district: "Kollam", city: "Kollam", lat: 8.8932, lng: 76.6141 },
  { state: "Kerala", district: "Pathanamthitta", city: "Pathanamthitta", lat: 9.2648, lng: 76.787 },
  ...
  { state: "Kerala", district: "Malappuram", city: "Malappuram", lat: 11.051, lng: 76.071 },
  { state: "Kerala", district: "Kozhikode", city: "Kozhikode", lat: 11.2588, lng: 75.7804 },
  { state: "Kerala", district: "Wayanad (Kalpetta)", city: "Kalpetta", lat: 11.609, lng: 76.0838 },
  ...
  { state: "Maharashtra", district: "Kolhapur", city: "Kolhapur", lat: 16.705, lng: 74.2433 },
  { state: "Maharashtra", district: "Amravati", city: "Amravati", lat: 20.932, lng: 77.7523 },
  ...
  { state: "Maharashtra", district: "Ratnagiri", city: "Ratnagiri", lat: 16.9944, lng: 73.3 },
  { state: "Maharashtra", district: "Raigad (Alibag)", city: "Alibag", lat: 18.6414, lng: 72.8722 },
  { state: "Maharashtra", district: "Palghar", city: "Palghar", lat: 19.697, lng: 72.7649 },
  ...
  // ───────────── Manipur ─────────────
  {
    ...
    lat: 24.817,
    lng: 93.9368,
    collectorPhone: "0385-2451065",
  },
  { state: "Manipur", district: "Imphal East", city: "Porompat", lat: 24.8019, lng: 93.9784 },
  { state: "Manipur", district: "Bishnupur", city: "Bishnupur", lat: 24.63, lng: 93.77 },
  { state: "Manipur", district: "Churachandpur", city: "Churachandpur", lat: 24.336, lng: 93.672 },
  { state: "Manipur", district: "Thoubal", city: "Thoubal", lat: 24.639, lng: 94.014 },
  { state: "Manipur", district: "Ukhrul", city: "Ukhrul", lat: 25.11, lng: 94.36 },
  ...
  {
    state: "Meghalaya",
    district: "Jaintia Hills (Jowai)",
    city: "Jowai",
    lat: 25.4498,
    lng: 92.203,
  },
  { state: "Meghalaya", district: "Ri-Bhoi (Nongpoh)", city: "Nongpoh", lat: 25.905, lng: 91.87 },
  ...
  // ───────────── Mizoram ─────────────
  {
    ...
    lat: 23.7271,
    lng: 92.7176,
    collectorPhone: "0389-2334555",
  },
  { state: "Mizoram", district: "Lunglei", city: "Lunglei", lat: 22.88, lng: 92.74 },
  { state: "Mizoram", district: "Champhai", city: "Champhai", lat: 23.457, lng: 93.329 },
  { state: "Mizoram", district: "Kolasib", city: "Kolasib", lat: 24.228, lng: 92.679 },
  ...
  // ───────────── Nagaland ─────────────
  {
    ...
    lat: 25.6747,
    lng: 94.1086,
    collectorPhone: "0370-2270222",
  },
  { state: "Nagaland", district: "Dimapur", city: "Dimapur", lat: 25.9091, lng: 93.7266 },
  { state: "Nagaland", district: "Mokokchung", city: "Mokokchung", lat: 26.322, lng: 94.517 },
  { state: "Nagaland", district: "Tuensang", city: "Tuensang", lat: 26.28, lng: 94.829 },
  { state: "Nagaland", district: "Wokha", city: "Wokha", lat: 26.098, lng: 94.262 },
  ...
  { state: "Odisha", district: "Koraput", city: "Koraput", lat: 18.812, lng: 82.71 },
  ...
  // ───────────── Punjab ─────────────
  {
    ...
    lat: 30.9009,
    lng: 75.8573,
    collectorPhone: "0161-2403100",
  },
  { state: "Punjab", district: "Amritsar", city: "Amritsar", lat: 31.634, lng: 74.8723 },
  { state: "Punjab", district: "Jalandhar", city: "Jalandhar", lat: 31.326, lng: 75.5762 },
  { state: "Punjab", district: "Patiala", city: "Patiala", lat: 30.3398, lng: 76.3869 },
  { state: "Punjab", district: "Bathinda", city: "Bathinda", lat: 30.211, lng: 74.9455 },
  { state: "Punjab", district: "Mohali (SAS Nagar)", city: "Mohali", lat: 30.7046, lng: 76.7179 },
  { state: "Punjab", district: "Pathankot", city: "Pathankot", lat: 32.274, lng: 75.652 },
  { state: "Punjab", district: "Hoshiarpur", city: "Hoshiarpur", lat: 31.532, lng: 75.912 },
  { state: "Punjab", district: "Ferozepur", city: "Ferozepur", lat: 30.9258, lng: 74.6133 },
  { state: "Punjab", district: "Moga", city: "Moga", lat: 30.817, lng: 75.1714 },
  ...
  { state: "Rajasthan", district: "Alwar", city: "Alwar", lat: 27.553, lng: 76.6346 },
  ...
  { state: "Sikkim", district: "South Sikkim (Namchi)", city: "Namchi", lat: 27.167, lng: 88.364 },
  { state: "Sikkim", district: "North Sikkim (Mangan)", city: "Mangan", lat: 27.508, lng: 88.526 },
  ...
  { state: "Tamil Nadu", district: "Salem", city: "Salem", lat: 11.6643, lng: 78.146 },
  ...
  { state: "Tamil Nadu", district: "Erode", city: "Erode", lat: 11.341, lng: 77.7172 },
  { state: "Tamil Nadu", district: "Vellore", city: "Vellore", lat: 12.9165, lng: 79.1325 },
  { state: "Tamil Nadu", district: "Thanjavur", city: "Thanjavur", lat: 10.787, lng: 79.1378 },
  ...
  { state: "Tamil Nadu", district: "Cuddalore", city: "Cuddalore", lat: 11.748, lng: 79.7714 },
  ...
  // ───────────── Tripura ─────────────
  {
    ...
    lat: 23.8315,
    lng: 91.2868,
    collectorPhone: "0381-2324412",
  },
  {
    state: "Tripura",
    district: "South Tripura (Belonia)",
    city: "Belonia",
    lat: 23.251,
    lng: 91.453,
  },
  {
    state: "Tripura",
    district: "North Tripura (Dharmanagar)",
    city: "Dharmanagar",
    lat: 24.37,
    lng: 92.169,
  },
  { state: "Tripura", district: "Dhalai (Ambassa)", city: "Ambassa", lat: 23.936, lng: 91.854 },
  ...
  { state: "Uttar Pradesh", district: "Bareilly", city: "Bareilly", lat: 28.367, lng: 79.4304 },
  { state: "Uttar Pradesh", district: "Aligarh", city: "Aligarh", lat: 27.8974, lng: 78.088 },
  ...
  { state: "Uttar Pradesh", district: "Saharanpur", city: "Saharanpur", lat: 29.968, lng: 77.551 },
  ...
  { state: "Uttar Pradesh", district: "Ayodhya", city: "Ayodhya", lat: 26.799, lng: 82.204 },
  {
    state: "Uttar Pradesh",
  ...
  {
    state: "Uttarakhand",
    district: "Udham Singh Nagar (Rudrapur)",
    city: "Rudrapur",
    lat: 28.9784,
    lng: 79.4081,
  },
  { state: "Uttarakhand", district: "Pauri Garhwal", city: "Pauri", lat: 30.1469, lng: 78.78 },
  {
    state: "Uttarakhand",
    district: "Tehri Garhwal (New Tehri)",
    city: "New Tehri",
    lat: 30.377,
    lng: 78.436,
  },
  { state: "Uttarakhand", district: "Almora", city: "Almora", lat: 29.598, lng: 79.659 },
  { state: "Uttarakhand", district: "Pithoragarh", city: "Pithoragarh", lat: 29.583, lng: 80.209 },
  {
    state: "Uttarakhand",
  ...
  { state: "Uttarakhand", district: "Rudraprayag", city: "Rudraprayag", lat: 30.284, lng: 78.981 },
  ...
  {
    state: "West Bengal",
    district: "South 24 Parganas (Alipore)",
    city: "Alipore",
    lat: 22.53,
    lng: 88.332,
  },
  ...
  {
    state: "West Bengal",
    district: "Murshidabad (Berhampore)",
    city: "Berhampore",
    lat: 24.0975,
    lng: 88.2495,
  },
  ...
  { state: "West Bengal", district: "Darjeeling", city: "Darjeeling", lat: 27.041, lng: 88.2663 },
  {
    state: "West Bengal",
    district: "Siliguri (Jalpaiguri)",
    city: "Siliguri",
    lat: 26.7271,
    lng: 88.3953,
  },
  { state: "West Bengal", district: "Malda", city: "Malda", lat: 25.0119, lng: 88.1433 },
  { state: "West Bengal", district: "Purulia", city: "Purulia", lat: 23.332, lng: 86.365 },
  { state: "West Bengal", district: "Bankura", city: "Bankura", lat: 23.233, lng: 87.075 },
  ...
  // ───────────── Andaman & Nicobar Islands ─────────────
  {
    ...
    lat: 11.6234,
    lng: 92.7265,
    collectorPhone: "03192-233089",
  },
  {
    state: "Andaman and Nicobar Islands",
    district: "North & Middle Andaman (Mayabunder)",
    city: "Mayabunder",
    lat: 12.93,
    lng: 92.9,
  },
  ...
  {
    state: "Dadra and Nagar Haveli and Daman and Diu",
    district: "Dadra & Nagar Haveli (Silvassa)",
    city: "Silvassa",
    lat: 20.2738,
    lng: 72.9961,
  },
  ...
  { state: "Delhi", district: "East Delhi", city: "Preet Vihar", lat: 28.631, lng: 77.2956 },
  { state: "Delhi", district: "West Delhi", city: "Rajouri Garden", lat: 28.647, lng: 77.1216 },
  { state: "Delhi", district: "South-West Delhi", city: "Dwarka", lat: 28.5921, lng: 77.046 },
  { state: "Delhi", district: "North-West Delhi", city: "Rohini", lat: 28.7041, lng: 77.1025 },
  { state: "Delhi", district: "North-East Delhi", city: "Seelampur", lat: 28.6708, lng: 77.268 },
  {
    state: "Delhi",
  ...
  { state: "Delhi", district: "Shahdara", city: "Shahdara", lat: 28.6735, lng: 77.289 },
  ...
  // ───────────── Jammu & Kashmir ─────────────
  {
    ...
    lat: 34.0837,
    lng: 74.7973,
    collectorPhone: "0194-2452002",
  },
  { state: "Jammu and Kashmir", district: "Jammu", city: "Jammu", lat: 32.7266, lng: 74.857 },
  {
    state: "Jammu and Kashmir",
    district: "Anantnag",
    city: "Anantnag",
  ...
  { state: "Jammu and Kashmir", district: "Kathua", city: "Kathua", lat: 32.37, lng: 75.52 },
  ...
  {
    state: "Lakshadweep",
    district: "Lakshadweep (Kavaratti)",
    city: "Kavaratti",
    lat: 10.5667,
    lng: 72.6417,
    collectorPhone: "04896-262258",
  },
  ...
  // ───────────── Puducherry ─────────────
  {
    ...
    lat: 11.9416,
    lng: 79.8083,
    collectorPhone: "0413-2253555",
  },
  { state: "Puducherry", district: "Karaikal", city: "Karaikal", lat: 10.9254, lng: 79.838 },
  { state: "Puducherry", district: "Mahé", city: "Mahé", lat: 11.7011, lng: 75.536 },
